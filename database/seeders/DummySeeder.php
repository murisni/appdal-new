...
class DummySeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Hapus histori lama (tabel biasanya bernama histori_penerimaan atau histori_penerimaans)
        DB::table('histori_penerimaan')->truncate();
        Schema::enableForeignKeyConstraints();

        // ====================================================================
        // COPY FOTO DARI public/img KE storage/app/public/dummy
        // ====================================================================
        $fotoDibutuhkan = [
            'ktp.jpg',
            'kk.jpg',
        ...
        // GENERATE 40 DATA KARTU KELUARGA
        for ($i = 0; $i < 40; $i++) {
    ...
    private function generateHistori(object $faker, string $jenisBantuan, int $dtksId): void
    {
        ...
        // FIX BUG ENUM MySQL: Ubah PBIJK menjadi PBI-JK agar sesuai migration
        ...
        for ($h = 0; $h < $jumlah; $h++) {
            ...
            // INSERT LANGSUNG KE TABEL HISTORI_PENERIMAAN
            DB::table('histori_penerimaan')->insert([
                'dtks_id'            => $dtksId,
                'program'            => $programEnum, // <--- Ini perbaikannya (pakai $programEnum)
