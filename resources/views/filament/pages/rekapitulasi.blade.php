<x-filament-panels::page>
    <x-filament::section>
        <x-slot name="heading">Filter Data Rekapitulasi</x-slot>
        <x-slot name="description">Sesuaikan parameter di bawah ini untuk menyaring laporan penerima bantuan.</x-slot>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <x-filament::input.wrapper>
                    <x-filament::input.select wire:model.live="program">
                        <option value="semua">-- Semua Data DTKS --</option>
            ...
            @if($program !== 'semua')
            <div class="flex flex-col gap-2">
                <label class="text-sm font-medium leading-none text-gray-950 dark:text-white">Status Verifikasi</label>
                <x-filament::input.wrapper>
                    <x-filament::input.select wire:model.live="status_verifikasi">
                        <option value="semua">-- Semua Status --</option>
                        <option value="ditinjau">Dalam Peninjauan</option>
                        <option value="diproses">Sedang diSurvey</option>
                        <option value="diterima">Diterima (Layak & Aktif)</option>
