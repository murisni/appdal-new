...
<head>
    ...
    <style>
        ...
        tbody td { font-size: 8pt; text-align: left; }
        ...
        <thead>
            <tr>
                ...
                @elseif($program === 'pkh')
                    ...
                    @if($statusVerif === 'ditolak') <th>Catatan Penolakan</th> @endif
                @elseif($program === 'bpnt')
            ...
            <tr>
                ...
                @if($program === 'semua')
                    ...
                    <td>
                        <ul style="margin:0; padding-left:15px; font-size:8pt;">
                            @if($row->pkh) <li>PKH: {{ ucfirst($row->pkh->status) }}</li> @endif
                            @if($row->bpnt) <li>BPNT: {{ ucfirst($row->bpnt->status) }}</li> @endif
                            @if($row->pbijk) <li>PBI-JK: {{ ucfirst($row->pbijk->status) }}</li> @endif
                            @if($row->atensi) <li>ATENSI: {{ ucfirst($row->atensi->status) }}</li> @endif
                ...
                @elseif($program === 'pkh' && $row->pkh)
                    ...
                    @if($statusVerif === 'ditolak')
                        <td><i class="text-danger">{{ $row->pkh->catatan_surveyor ?? 'Tidak ada catatan' }}</i></td>
                    @endif
                ...
                @elseif($program === 'bpnt' && $row->bpnt)
                    ...
                    @if($statusVerif === 'ditolak')
                        <td><i class="text-danger">{{ $row->bpnt->catatan_surveyor ?? 'Tidak ada catatan' }}</i></td>
                    @endif
                ...
                @elseif($program === 'pbijk' && $row->pbijk)
                    ...
                    @if($statusVerif === 'ditolak')
                        <td><i class="text-danger">{{ $row->pbijk->catatan_surveyor ?? 'Tidak ada catatan' }}</i></td>
                    @endif
                ...
                @elseif($program === 'atensi' && $row->atensi)
                    ...
                    @if($statusVerif === 'ditolak')
                        <td><i class="text-danger">{{ $row->atensi->catatan_surveyor ?? 'Tidak ada catatan' }}</i></td>
                    @endif
